...
RSpec.describe Shelter, type: :model do
  ...
  describe 'class methods' do
    ...
    describe '#reverse_shelter_order' do
      it 'orders the shelters in reverse alphabetial order' do
        expect(Shelter.reverse_shelter_order).to eq([@shelter_2, @shelter_3, @shelter_1])
      end
    end
